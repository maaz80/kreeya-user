     ...
     return (
          <div className='max-w-275 mx-auto mt-35 md:mt-40  px-2 md:px-0'>
               ...
               <p className="mt-6 text-sm md:text-base xl:text-[24px] text-dark-black max-w-300 leading-7 md:leading-9 plus-jakarta-sans">
                    {description || "As financial UX pioneers we don’t just improve—we reinvent. Dopamine Banking's approach and digital experience branding empower financial brands, drive digital growth and create rich digital experiences that go far beyond generic service design."}
               </p>
               {/* Video */}
