               ...
               <div className="max-w-full lg:max-w-300 3xl:max-w-[1680px] mx-auto">
                    ...
                    <div className="mt-4 md:mt-8 lg:mt-14 grid grid-cols-1 lg:grid-cols-3 gap-12 items-start">
                         ...
                         <div className="text-dark-gray text-[14px] md:text-[24px] max-w-full lg:max-w-206 col-span-2">
                              <p>
                                   Most users struggle with traditional finance apps because they are cluttered, overwhelming, and visually noisy. Spending patterns are hard to interpret, and important information is either buried or confusing.
                              </p>
                              ...
                              <ul className="list-disc ml-4 md:ml-6">
                                   <li>give users a clear understanding of their finances,</li>
                                   <li>help them track spending intuitively,</li>
                                   <li>make money management feel effortless, not stressful.</li>
                              </ul>
                         </div>
