...
const Testimonial = () => {
     ...
     return (
          <div className="relative min-h-150 text-white pt-27 lg:pt-8">
               ...
               {/* Content */}
               <div className="relative z-10 max-w-300 mx-auto mt-10 md:mt-20 lg:mt-40 flex flex-col lg:flex-row items-center lg:items-start justify-between gap-10 mb-10 md:mb-20 px-5 lg:px-0 ">
                    ...
                    {/* Right */}
                    <div className="flex gap-4 md:gap-8 max-w-150 plus-jakarta-sans w-full lg:w-[50%]">
