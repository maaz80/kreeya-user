...
const Services = ({ service }) => {
     ...
     return (
          <section id="service-services" className="relative w-full py-10 md:py-24 px-4 md:px-8 overflow-hidden bg-linear-to-b from-[#003D64] via-[#007CC9] to-[#003D64] text-white ">
               ...
               <div className="relative max-w-310 mx-auto text-center plus-jakarta-sans flex flex-col justify-center items-center">
                    ...
                    <h2 className="poiret-one-regular text-[32px] md:text-[56px] xl:text-[72px] leading-10 md:leading-15">
                         {data?.title || "Our Specialized Services"}
                    </h2>
...
const services = [
     {
          para: "Brand identity — Logo, colours, typography",
          image: CardImg,
     },
     {
          para: "Web design — Conversion-led websites",
          image: CardImg,
     },
     {
          para: "UI/UX design — Apps and dashboards",
          image: CardImg,
     },
     {
          para: "Digital marketing — SEO and leads",
          image: CardImg,
     },
     {
          para: "Brand identity — Logo, colours, typography",
